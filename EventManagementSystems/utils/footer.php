            ...
            <section>
                <div class = "footerContent col-md-4"><!--left content-->
                    <p class = "footerContent1">
                        <span class = "small footerSubtext"><strong>Sai</strong></span>
                       <span class = "small footerSubtext"><strong>Vidya</strong></span>
                        <span class = "small footerSubtext"><strong>Institute of</strong></span>
                       <span class = "small footerSubtext"><strong>Technology</strong></span>
                    </p>
...
<p WIDTH=100% HEIGHT=80 DIRECTION=LEFT  behavior="alternate" style="background-color:#1f004d ; color:#ffffff ; font-size:25px ;text-align: center">
---------------Designed by Bhavana.G and Annapoorna.B.A---------------
</p>
