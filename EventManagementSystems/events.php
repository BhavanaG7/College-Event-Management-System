            ...
            <div class="container">
                ...
                <div class="subcontent col-md-6">
                    ...
                    <p style="color:#003300  ;font-size:20px "><!--content-->
                        ...
                        echo 'Merit to be earned:' . $row['merit_earned'] . '<br>';
                        ?>
                    </p>

                    <br><br>
                    <?php echo '<a class="btn btn-default" href="register.php"> <span class="glyphicon glyphicon-circle-arrow-right"></span>Register</a>'; ?>
                </div><!--subcontent div-->
            </div><!--container div-->
        </section>
    </div>
